...
const MyCourses = () => {
  ...
  return (
    <div className="p-6 md:pb-32 pb-32 md:px-44 bg-gray-100 w-full overflow-y-auto">
      <DashBoardHeader title="MY COURSES" subTitle="My Courses" />
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-gray-100">
        {courses.map((course, index) => (
          ...
          >
            ...
            <div className="relative">
              <img src={course.image} alt="Course" className="w-full h-56" />
            ...
            {/* Course info */}
            <div className="p-4">
              <h3 className="text-gray-500 h-12 pb-1 font-bold text-lg leading-tight">
                {course.title}
              </h3>
              ...
              {/* Continue Button */}
              <button className="mt-4 w-full flex items-center justify-center gap-2 bg-[#BA0000] hover:bg-[#BA0000] text-white py-2 rounded transition duration-300">
